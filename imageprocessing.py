...
def main_screen(choice = 7):
    ...
    if choice == 1:
        filename = askopenfilenames(title='Choose a file', filetypes=[('Pictures', ' *.png | *.jpg | *.JPG | *.PNG')])
        return filename, choice
        # choiceEdge(filename)
    elif choice == 2:
        filename = askopenfilenames(title='Choose a file', filetypes=[("Pictures", " *.png | *.jpg | *.JPG | *.PNG")])  # show an "Open" dialog box and return the path to the selected file
        return filename, choice
        # print(filename)
    elif choice == 3:
        filename = askopenfilenames(title='Choose a file', filetypes=[("Pictures", " *.png | *.jpg | *.JPG | *.PNG")])  # show an "Open" dialog box and return the path to the selected file
        ...
        if try2 == 1:
            ...
            filename = askopenfilename(title='Choose a file', filetypes=[("Pictures", " *.png | *.jpg | *.JPG | *.PNG")])  # show an "Open" dialog box and return the path to the selected file
            try2 = 0
        return filename, choice
    elif choice == 6:
        print("Good Bye! ")
